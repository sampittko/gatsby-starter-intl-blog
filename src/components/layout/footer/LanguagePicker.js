...
const LanguagePicker = ({ intl }) => (
  <select
    className="block text-gray-600 text-xs appearance-none w-auto bg-white dark:bg-gray-900 rounded leading-tight focus:outline-none focus:border-gray-500 cursor-pointer text-center hover:underline"
