...
const LanguagePicker = ({ intl }) => {
  ...
  return (
    <select
      className="py-3 block text-gray-600 text-xs appearance-none w-auto bg-white bg-opacity-75 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500 cursor-pointer text-center hover:underline"
